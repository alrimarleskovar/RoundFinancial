...
<p>
  ...
  <a href="docs/devnet-deployment.md"><img alt="Devnet · cycle 0 closed" src="https://img.shields.io/badge/Devnet-cycle_0_closed-00C8FF?style=for-the-badge&logo=solana&logoColor=06090F"/></a>
</p>
...
| 9. Security audit          | ⏳                                                                                                                                                                                                                                                                                                                                                                           |
| 10. Devnet testing         | 🟢 Cycle 0 closed end-to-end on devnet — `create_pool` → 3 × `join_pool` (Lv1 stakes + position NFTs) → 3 × `contribute` (split across solidarity / escrow / float) → `claim_payout` for slot 0 → `pool.current_cycle` advanced 0 → 1 → 4 reputation `Attestation` PDAs. See [`docs/devnet-deployment.md`](docs/devnet-deployment.md). Cycles 1 + 2 + `release_escrow` next. |

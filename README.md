...
<sub>**Status:** M3 shipped · 4 programs live on devnet · reproducible-build attestation on-chain · **mainnet-canary code controls complete** (Kamino harvest CPI, TVL caps per-pool + protocol-wide, yield-adapter allowlist + lock-flag, devnet→mainnet network-confusion banner, Squads multisig procedure docs, Civic→Human-Passport PoP migration) · **237 tests across 21 spec files** (53 security-specific bankrun + 58 app-encoder structural + 7 bankrun round-trips + 10 canary-control negative + 109 lifecycle/edge/parity) · 6 cargo-fuzz targets on `roundfi-math` · **external audit + Squads ceremony + bug bounty pending** — see [`MAINNET_READINESS.md`](MAINNET_READINESS.md). _Last updated: May 2026._</sub>
...
| 11. Mainnet migration      | 🟡 **Canary code controls shipped, external ceremony pending.** Code-side (this sprint): Kamino harvest CPI ([#309](https://github.com/alrimarleskovar/RoundFinancial/pull/309)), TVL caps per-pool + protocol-wide ([#310](https://github.com/alrimarleskovar/RoundFinancial/pull/310) + [#314](https://github.com/alrimarleskovar/RoundFinancial/pull/314) orphan-PDA fix), yield-adapter allowlist + lock-flag ([#311](https://github.com/alrimarleskovar/RoundFinancial/pull/311) + [#316](https://github.com/alrimarleskovar/RoundFinancial/pull/316)), devnet/mainnet network-confusion banner ([#312](https://github.com/alrimarleskovar/RoundFinancial/pull/312)), Squads multisig procedure + PDA-derivation utility ([#313](https://github.com/alrimarleskovar/RoundFinancial/pull/313)), negative bankrun coverage on canary controls ([#315](https://github.com/alrimarleskovar/RoundFinancial/pull/315)), Civic→Human-Passport PoP provider migration ([#317](https://github.com/alrimarleskovar/RoundFinancial/pull/317)). External (off-protocol, not tractable in code): **Adevar Labs audit** (Q2-Q3 2026), **3-of-5 Squads multisig ceremony** (hardware-wallet quorum), **bug bounty live** (at GA), **legal counsel review** (Q3 2026). See [`MAINNET_READINESS.md`](MAINNET_READINESS.md) for the full checklist.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |

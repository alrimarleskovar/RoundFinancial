...
async function main() {
  ...
  // deploy, so this is just a build-time optimization. (Anchor 1.0 emits
  // IDLs natively post-#487; the old anchor-syn #319 patch workaround is
  // retired. Run a plain `anchor build` if you need the IDLs locally.)

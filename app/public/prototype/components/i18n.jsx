...
const DICT = {
  pt: {
    ...
    'wallet.faucet.rate':   'Limite do RPC público atingido. Use o faucet hospedado:',
    ...
    'wallet.faucet.usdcSub':  'USDC devnet não é distribuído pelo RPC. Use o faucet oficial da Circle.',
  ...
  en: {
    ...
    'wallet.faucet.usdcSub':  'Devnet USDC is not distributed by the RPC. Use Circle’s official faucet.',
...
const APP_STATE = {
  ...
  connections: {
    ...
    phantom:  { status: 'disconnected' },  // real state — driven by wallet.jsx

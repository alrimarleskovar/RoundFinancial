...
export const DICT: Record<Lang, Dict> = {
  pt: {
    ...
    "insightsv2.chart.hint": "Toque em cada ponto para ver o que mudou no seu score",
    "insightsv2.chart.ev.join": "Entrou no grupo",
    "insightsv2.chart.ev.joinPool": "Entrou · {pool}",
    "insightsv2.chart.ev.payment": "Parcela paga",
    ...
    "admin.cranker.radar.delivers": "entrega",
    ...
    // home mobile (redesign do Caio) — namespace próprio: a copy curta do
    // celular é uma decisão de design, não uma tradução da do desktop.
    "mhome.tier": "Tier {n}",
    "mhome.protected": "Saldo protegido",
    "mhome.inYield": "em yield",
    "mhome.passport": "SAS Passport",
    "mhome.passportSub": "reputação on-chain",
    "mhome.score": "score",
    "mhome.idPending": "ID pendente",
    "mhome.tier.trusted": "Trusted",
    "mhome.tier.building": "Building",
    "mhome.nextAction": "Próxima ação",
    "mhome.dueIn": "Sua parcela vence em",
    "mhome.days": "{n} dias",
    "mhome.installmentAmount": "Valor da parcela",
    "mhome.payNow": "Pagar agora",
    "mhome.activeCycle": "Ciclo ativo",
    "mhome.viewDetails": "Ver detalhes de {g}",
    "mhome.installmentsOf": "{m}/{t} parcelas",
    "mhome.members": "{n} membros",
    "mhome.passportInfo":
      "Sua reputação on-chain. Ela sobe a cada parcela paga em dia e é o que destrava grupos de nível maior — ninguém consulta seu CPF, só o seu histórico aqui.",
    "mhome.passportInfo.aria": "O que é o passaporte SAS?",
    "mhome.passportInfo.dismiss": "Toque para fechar",
    "mhome.cyclesTitle": "Meus ciclos ativos",
    "mhome.seeAll": "Ver todos",
    "mhome.seeAllF": "Ver todas",
    "mhome.empty.title": "Nenhum ciclo ativo",
    "mhome.empty.body": "Entre em um grupo para construir seu histórico.",
    "mhome.empty.cta": "Explorar grupos",
    "mhome.cyclesLabel": "Ciclos",
    "mhome.cyclesValue": "Valor dos ciclos",
    "mhome.tierLabel": "Tier atual",
    "mhome.achievements": "Próximas conquistas",
    "mhome.mission.onTime": "Pague 2 parcelas no prazo",
    "mhome.mission.join": "Entre em um novo grupo",
    "mhome.mission.cycle": "Complete um ciclo",
    // sell share
    ...
    "groupsV2.stat.availableShort": "{n} abertos",
    "groupsV2.stat.compatibleShort": "{n} no seu nível",
    ...
    "marketV2.compact.buyPrice": "Valor para comprar",
    "marketV2.compact.remaining": "Valor restante",
    "marketV2.compact.verified": "Vendedor verificado",
    "marketV2.compact.stats": "Estatísticas do mercado",
    "groupsV2.tab.available": "Disponíveis",
    "groupsV2.tab.mine": "Meus grupos",
    "groupsV2.tab.completed": "Concluídos",
    "groupsV2.compact.byDraw": "Sorteio",
    "groupsV2.compact.byOrder": "Ordem definida",
    "groupsV2.compact.cycleOf": "Ciclo {c} de {t}",
    "groupsV2.compact.termLevel": "{d} · Nível {lv}",
    "groupsV2.compact.vacancies": "{n} vagas disponíveis",
    "groupsV2.compact.result": "Resultado do ciclo",
    "groupsV2.compact.finished": "Ciclo concluído",
    "groupsV2.compact.follow": "Acompanhar grupo",
    "groupsV2.compact.history": "Ver histórico",
    ...
    "wallet.connections.entry": "Carteiras e alertas por e-mail",
  ...
  en: {
    ...
    "insightsv2.chart.hint": "Tap each point to see what changed in your score",
    "insightsv2.chart.ev.join": "Joined the group",
    "insightsv2.chart.ev.joinPool": "Joined · {pool}",
    "insightsv2.chart.ev.payment": "Installment paid",
    ...
    "admin.cranker.radar.delivers": "delivers",
    ...
    // mobile home (Caio's redesign) — its own namespace: the phone's short
    // copy is a design decision, not a translation of the desktop copy.
    "mhome.tier": "Tier {n}",
    "mhome.protected": "Protected balance",
    "mhome.inYield": "in yield",
    "mhome.passport": "SAS Passport",
    "mhome.passportSub": "on-chain reputation",
    "mhome.score": "score",
    "mhome.idPending": "ID pending",
    "mhome.tier.trusted": "Trusted",
    "mhome.tier.building": "Building",
    "mhome.nextAction": "Next action",
    "mhome.dueIn": "Your installment is due in",
    "mhome.days": "{n} days",
    "mhome.installmentAmount": "Installment amount",
    "mhome.payNow": "Pay now",
    "mhome.activeCycle": "Active cycle",
    "mhome.viewDetails": "View details for {g}",
    "mhome.installmentsOf": "{m}/{t} installments",
    "mhome.members": "{n} members",
    "mhome.passportInfo":
      "Your on-chain reputation. It rises with every installment paid on time and is what unlocks higher-level groups — nobody checks a credit bureau, only your history here.",
    "mhome.passportInfo.aria": "What is the SAS passport?",
    "mhome.passportInfo.dismiss": "Tap to close",
    "mhome.cyclesTitle": "My active cycles",
    "mhome.seeAll": "See all",
    "mhome.seeAllF": "See all",
    "mhome.empty.title": "No active cycle",
    "mhome.empty.body": "Join a group to start building your history.",
    "mhome.empty.cta": "Explore groups",
    "mhome.cyclesLabel": "Cycles",
    "mhome.cyclesValue": "Cycles value",
    "mhome.tierLabel": "Current tier",
    "mhome.achievements": "Next achievements",
    "mhome.mission.onTime": "Pay 2 installments on time",
    "mhome.mission.join": "Join a new group",
    "mhome.mission.cycle": "Complete a cycle",
    // sell share
    ...
    "groupsV2.stat.availableShort": "{n} open",
    "groupsV2.stat.compatibleShort": "{n} at your level",
    ...
    "marketV2.compact.buyPrice": "Purchase price",
    "marketV2.compact.remaining": "Remaining value",
    "marketV2.compact.verified": "Verified seller",
    "marketV2.compact.stats": "Market statistics",
    "groupsV2.tab.available": "Available",
    "groupsV2.tab.mine": "My groups",
    "groupsV2.tab.completed": "Completed",
    "groupsV2.compact.byDraw": "Draw",
    "groupsV2.compact.byOrder": "Fixed order",
    "groupsV2.compact.cycleOf": "Cycle {c} of {t}",
    "groupsV2.compact.termLevel": "{d} · Level {lv}",
    "groupsV2.compact.vacancies": "{n} spots available",
    "groupsV2.compact.result": "Cycle result",
    "groupsV2.compact.finished": "Cycle completed",
    "groupsV2.compact.follow": "Track group",
    "groupsV2.compact.history": "View history",
    ...
    "wallet.connections.entry": "Wallets and email alerts",

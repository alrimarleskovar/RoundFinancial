...
If accepted, I'll continue the same workflow that produced this bundle:

- Public PRs, structured bodies, traceable to Claude sessions.
- Open-source the bridge code + tests.
- Write a short post-mortem at the end of the 6 weeks documenting what 8–10 more PRs of agentic engineering looks like in concrete terms — the kind of thing the next applicant can read to know what's possible.

Thanks for reading. The repo is at https://github.com/alrimarleskovar/RoundFinancial — open every PR, click any session link.

...
> the formal engagement — **51 findings catalogued, 47 closed,
> 1 🟡 OPEN (SEV-050, High — defaulted pool cannot `close_pool`,
> escrow never drains to 0 → stranded funds; fix deferred, a
> mainnet blocker)** (Critical/High **15 of 16** including SEV-034b
> surfaced by the integration-testing wave, SEV-040 / SEV-041 /
> SEV-042 surfaced by the Kamino-spike pre-audit, SEV-047 / SEV-048
> from the 2026-05-24 external-audit pass, and SEV-049 pre-contemplation-default
> liveness fix from the litesvm L1↔L2 parity slice — live counts
> canonical in the
...
Current date: **2026-05-26**. Hackathon submission complete (Colosseum 2026). Internal pre-audit complete (5 passes + integration-testing wave + 9 follow-up waves + 2026-05-24 external-audit pass, **47/51 findings closed; Critical/High 15 of 16 — 1 🟡 OPEN, SEV-050 (High), a defaulted-pool `close_pool` liveness mainnet blocker**; SEV-012 closed via a litesvm REQUIRED CI lane). Mainnet operational scaffolding shipped: SEV-046 CD pipeline (rehearsal 1g green 2026-05-19), Pass-14 indexer observability, Pass-15 Squads-aware emergency-response runbook. External-auditor formal engagement (Adevar / Halborn / OtterSec / Sec3 — selection pending) in scoping (cost/timeline negotiation).

| Phase                                                                                              | Window     | Status                                                                                                                                                                                                                                                                                    |
| -------------------------------------------------------------------------------------------------- | ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Internal self-audit + threat model                                                                 | Q1–Q2 2026 | ✅ Done — [`docs/security/self-audit.md`](./docs/security/self-audit.md) (228 lines)                                                                                                                                                                                                      |
| Internal pre-audit (5 passes + integration-testing wave + 9 follow-up waves + external-audit pass) | May 2026   | ✅ Done — 51 findings catalogued, 47 closed, 1 🟡 OPEN (SEV-050, High — mainnet blocker); Critical/High 15 of 16; [canonical Summary table](./docs/security/internal-audit-findings.md#summary). [`docs/security/internal-audit-findings.md`](./docs/security/internal-audit-findings.md) |
...
- **Duration:** 2-week scoped engagement (8,655 LoC is comfortably auditable in 2 weeks given the pre-documented invariants + 5-pass internal pre-audit + 9 follow-up waves + external-audit pass that closed 47/51 findings)

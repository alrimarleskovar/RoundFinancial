...
| 1g (next) | `devnet-deploy-v20260518-rehearsal-1g` (pending operator with ≥ 20 SOL) | TBD — should succeed; next failure (if any) is RPC/Solana-side, not workflow code                                                                                                                     | —                                                                  | Hopefully none                                                                                                                                                                                          |

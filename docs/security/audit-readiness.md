...
> - [`./internal-audit-findings.md`](./internal-audit-findings.md) — **internal pre-audit tracker (canonical counts in its [Summary table](./internal-audit-findings.md#summary); 49 findings / 45+ closed / Critical/High 14/14 as of 2026-05-24)** — read this first to see what the team's own red-team already surfaced
...
| ----------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Internal pre-audit (external-auditor methodology)** | **49 findings catalogued, 45+ 🟢 closed, 1 🟠 upstream-blocked, 3 🔵 design-intentional** (live counts canonical in the tracker [Summary table](./internal-audit-findings.md#summary)) | [`internal-audit-findings.md`](./internal-audit-findings.md) — public tracker, SEV-001..SEV-048 + SEV-034b                                         |
...
The internal pre-audit (W1..W5 + 1 integration-testing wave + 9 follow-up waves + 1 external-audit pass, 49 findings, 45+ closed) ran _before_ commissioning the formal external engagement. Recommended formal scope:
...
- Internal pre-audit tracker — [`internal-audit-findings.md`](./internal-audit-findings.md) (49 SEVs, 45+ closed, 1 upstream-blocked, 3 design-intentional; canonical [Summary table](./internal-audit-findings.md#summary))

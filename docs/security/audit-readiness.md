...
> - [`./internal-audit-findings.md`](./internal-audit-findings.md) — **internal pre-audit tracker (canonical counts in its [Summary table](./internal-audit-findings.md#summary); 51 findings / 48 closed / 0 open / Critical/High 16 of 16 as of 2026-05-26)** — read this first to see what the team's own red-team already surfaced
...
The internal pre-audit (W1..W5 + 1 integration-testing wave + 9 follow-up waves + 1 external-audit pass + litesvm L1↔L2 parity slice, 51 findings, 48 closed, 0 open) ran _before_ commissioning the formal external engagement. Recommended formal scope:
...
- Internal pre-audit tracker — [`internal-audit-findings.md`](./internal-audit-findings.md) (51 SEVs, 48 closed, 0 open, 1 partial (SEV-039), 0 upstream-blocked, 2 design-intentional; canonical [Summary table](./internal-audit-findings.md#summary))

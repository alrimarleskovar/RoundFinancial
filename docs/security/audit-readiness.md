...
| **Critical / High fixes**                   | **8/8 🟢 closed** with negative regression tests per "test-before-merge" gate            | PRs [#326..#351](https://github.com/alrimarleskovar/RoundFinancial/pulls?q=is%3Apr+is%3Amerged+SEV)            |

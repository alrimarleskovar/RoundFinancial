...
| ---------- | ------------ | ---------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-05-07 | `37d60c2`    | `64XM177Vm6zirzQnjU1juQ9TLqDsZVsCcZzfgEgVCffm` | Full M3 protocol surface across two pools + Escape Valve + **Pool 1 finalized via close_pool**. Pool 1: 3-cycle ROSCA closed end-to-end → release_escrow reverts with EscrowLocked → **close_pool emitted balanced summary log** (total_contributed=$90 = total_paid_out=$90, no yield/GF/fees on Pool 1 since deposit_idle was a Pool 2-only flow). Pool 2 (cycle_duration=3600s): ON-TIME contribs + yield Cascade + positive release_escrow + escape_valve_list + escape_valve_buy. Found-and-fixed mpl-core protocol bug. 13 reputation `Attestation` PDAs, 2 Triple Shield guards captured firing, 9 Solana 3.x Box workarounds applied, 1 protocol bug surfaced + fixed end-to-end. | Twelve sessions on the same day, culminating in #178. (1)–(11) per the previous cumulative entry: protocol deploy → init → Pool 1 lifecycle (3 cycles + claims + EscrowLocked negative) → Pool 2 + Yield Cascade + positive release_escrow → Escape Valve list + buy + plugin re-delegate fix (#160-#176). (12) **close_pool driver (#178)**: Box on `ClosePool`; `seed-close.ts` reads `pool.status` pre-call, aborts cleanly if not `Completed`. Pool 1 (status=Completed since #171) was the canonical target — close_pool emitted a balanced summary log proving the protocol's lifecycle invariant (total_contributed equals total_paid_out for a completed ROSCA with no yield). Pool 2 stays Active for any future testing of secondary-market or admin paths. Next M3 step: app↔chain wiring (front-end modals firing real txs against the deployed pools). |
